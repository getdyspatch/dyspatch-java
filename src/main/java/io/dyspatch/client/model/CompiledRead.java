...
public class CompiledRead {
  ...
  public static final String SERIALIZED_NAME_AMP_HTML = "ampHtml";
  @SerializedName(SERIALIZED_NAME_AMP_HTML)
  private byte[] ampHtml;
  ...
  **/
  ...
  @ApiModelProperty(example = "example@example.com", value = "Sender address")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example@example.com", value = "Reply-To address")
  ...
  **/
  ...
  public CompiledRead ampHtml(byte[] ampHtml) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Base64 encoded template AMP body")

  public byte[] getAmpHtml() {
    return ampHtml;
  }


  public void setAmpHtml(byte[] ampHtml) {
    this.ampHtml = ampHtml;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sender, compiledRead.sender) &&
        ...
        Arrays.equals(this.ampHtml, compiledRead.ampHtml) &&
        Arrays.equals(this.text, compiledRead.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sender, replyTo, Arrays.hashCode(subject), Arrays.hashCode(html), Arrays.hashCode(ampHtml), Arrays.hashCode(text));
  }
