...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-06T15:58:00.720-07:00[America/Vancouver]")public class Cursor {
  ...
  * @return next
  **/
  @Schema(description = "A cursor to fetch the next page of results")
  ...
  * @return hasMore
  **/
  @Schema(description = "Whether there is a next page of results")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(next, hasMore);
  }
