...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-11T13:58:00.092-07:00[America/Vancouver]")public class TemplateMetaRead {
  ...
  * @return name
  **/
  @Schema(description = "The name of a template")
  ...
  * @return url
  **/
  @Schema(example = "/templates/tem_g3L7Cw6Hp5wUaf395LehwK", description = "The API url for a specific template")
  ...
  **/
  @Schema(description = "A list of the template's available localization objects")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, name, description, url, localizations, createdAt, updatedAt);
  }
