...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-06-06T15:58:00.720-07:00[America/Vancouver]")public class TemplateRead {
  ...
  **/
  ...
  public TemplateRead createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public TemplateRead updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  @Schema(description = "A list of the Template's available localizations")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, name, description, url, compiled, createdAt, updatedAt, localizations);
  }
